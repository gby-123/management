...
const Comp: React.FC = () => {
  ...
  // 拿着currentRoute.pathname跟items数组的每一项的children的key值进行对比，如果找到相等了，就要他上一级的key
  ...
  // items[]['children'].find(findKey);//这个结果如果找到拿到的，就是找到的这个对象，转布尔值就是true。找不到就是false
